class Admin::PostsController < Admin::BaseController
  ...
  def create
    ...
    if @post.save
      redirect_to admin_posts_pages_path, notice: "New post published."
    else
  ...
  def update
    ...
    if @post.update(post_params)
      redirect_to admin_posts_pages_path, notice: "Post successfully edited."
    else
  ...
  def destroy
    @post.destroy
    redirect_to admin_posts_pages_path, notice: "The post has been deleted."
  end
